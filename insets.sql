...
INSERT INTO Provincias (nombre) VALUES ('Tierra del Fuego, Antártida e Islas del Atlántico Sur');
...
-- EstadoCuota
INSERT INTO EstadoCuota (estado) VALUES 
('Pendiente'),
('Pagada'),
('Vencida');
...
INSERT INTO TipoProductoFinanciero (tipo) VALUES 
('Préstamo Personal'),
...
INSERT INTO CampaniaPromocional (nombre, descripcion, fechaInicio, fechaFin, resultados) VALUES 
...
('Inversión Agro 2025', 'Línea de crédito especial para el sector agropecuario con tasas subsidiadas.', '2025-04-01', '2025-09-30', 'Impacto medio en provincias del interior.'),
...
INSERT INTO EvaluacionRiesgo (puntajeRiesgo, ingresosDeclaradosMensual, observaciones) VALUES
...
-- Garante 
INSERT INTO Garante (nombre, apellido, dni, email, observaciones) VALUES 
...
--  Sucursal 
-- Se usan idProvincias 1 (Buenos Aires), 6 (Córdoba), 13 (Mendoza), 21 (Santa Fe), 2 (CABA)
INSERT INTO Sucursal (nombre, idProvincia, telefono, direccion) VALUES 
...
INSERT INTO ProductoFinanciero (idTipoProducto, nombre, requisitos, limiteCrediticio) VALUES 
...
-- Empleado
INSERT INTO Empleado (idSucursal, idTipoEmpleado, nombre, apellido, dni, email) VALUES
-- SUCURSAL 1 (CABA - 12 Empleados)
(1, 4, 'Hilda', 'Gutiérrez', '50000001', 'hilda.gutierrez.s1@empresa.com'), -- Gerente
(1, 2, 'Claudio', 'Arias', '50000002', 'claudio.arias.s1@empresa.com'),   -- Analista
(1, 2, 'Estela', 'Bustos', '50000003', 'estela.bustos.s1@empresa.com'),   -- Analista
(1, 3, 'Ruben', 'Carrizo', '50000004', 'ruben.carrizo.s1@empresa.com'),   -- Cobranza
(1, 3, 'Sara', 'Delgado', '50000005', 'sara.delgado.s1@empresa.com'),     -- Cobranza
(1, 1, 'Teresa', 'Fuentes', '50000006', 'teresa.fuentes.s1@empresa.com'),  -- Atención
(1, 1, 'Omar', 'Gálvez', '50000007', 'omar.galvez.s1@empresa.com'),       -- Atención
(1, 1, 'Marta', 'Juárez', '50000008', 'marta.juarez.s1@empresa.com'),      -- Atención
(1, 1, 'Lucas', 'Leiva', '50000009', 'lucas.leiva.s1@empresa.com'),        -- Atención
(1, 1, 'Iris', 'Molina', '50000010', 'iris.molina.s1@empresa.com'),        -- Atención
(1, 5, 'Gustavo', 'Nieto', '50000011', 'gustavo.nieto.s1@empresa.com'),    -- Administrativo
(1, 5, 'Pamela', 'Ochoa', '50000012', 'pamela.ochoa.s1@empresa.com'),     -- Administrativo
-- SUCURSAL 2 (Córdoba - 12 Empleados)
(2, 4, 'Daniel', 'Paz', '50000013', 'daniel.paz.s2@empresa.com'),         -- Gerente
(2, 2, 'Elena', 'Quiroga', '50000014', 'elena.quiroga.s2@empresa.com'),   -- Analista
(2, 2, 'Fernando', 'Ríos', '50000015', 'fernando.rios.s2@empresa.com'),   -- Analista
(2, 3, 'Andrea', 'Sosa', '50000016', 'andrea.sosa.s2@empresa.com'),       -- Cobranza
(2, 3, 'Victor', 'Tapia', '50000017', 'victor.tapia.s2@empresa.com'),     -- Cobranza
(2, 1, 'Silvia', 'Ugarte', '50000018', 'silvia.ugarte.s2@empresa.com'),   -- Atención
(2, 1, 'Juan', 'Vidal', '50000019', 'juan.vidal.s2@empresa.com'),          -- Atención
(2, 1, 'Noelia', 'Yáñez', '50000020', 'noelia.yanez.s2@empresa.com'),      -- Atención
(2, 1, 'Raúl', 'Zárate', '50000021', 'raul.zarate.s2@empresa.com'),        -- Atención
(2, 1, 'Karina', 'Alonso', '50000022', 'karina.alonso.s2@empresa.com'),    -- Atención
(2, 5, 'Marcos', 'Blanco', '50000023', 'marcos.blanco.s2@empresa.com'),    -- Administrativo
(2, 3, 'Gabriela', 'Cáceres', '50000024', 'gabriela.caceres.s2@empresa.com'), -- Cobranza
-- SUCURSAL 3 (Mendoza - 12 Empleados)
(3, 4, 'Lucia', 'Durán', '50000025', 'lucia.duran.s3@empresa.com'),       -- Gerente
(3, 2, 'Maxi', 'Escobar', '50000026', 'maxi.escobar.s3@empresa.com'),     -- Analista
(3, 2, 'Natalia', 'Fuentes', '50000027', 'natalia.fuentes.s3@empresa.com'), -- Analista
(3, 3, 'Oscar', 'Giménez', '50000028', 'oscar.gimenez.s3@empresa.com'),   -- Cobranza
(3, 3, 'Flavia', 'Herrera', '50000029', 'flavia.herrera.s3@empresa.com'),  -- Cobranza
(3, 1, 'Renzo', 'Ibañez', '50000030', 'renzo.ibanez.s3@empresa.com'),     -- Atención
(3, 1, 'Soledad', 'Jara', '50000031', 'soledad.jara.s3@empresa.com'),     -- Atención
(3, 1, 'Pedro', 'Kunz', '50000032', 'pedro.kunz.s3@empresa.com'),         -- Atención
(3, 1, 'Vanesa', 'López', '50000033', 'vanesa.lopez.s3@empresa.com'),      -- Atención
(3, 1, 'Tomás', 'Méndez', '50000034', 'tomas.mendez.s3@empresa.com'),      -- Atención
(3, 5, 'Úrsula', 'Núñez', '50000035', 'ursula.nunez.s3@empresa.com'),      -- Administrativo
(3, 2, 'Walter', 'Ortiz', '50000036', 'walter.ortiz.s3@empresa.com'),     -- Analista
-- SUCURSAL 4 (Rosario - 12 Empleados)
(4, 4, 'Ximena', 'Paredes', '50000037', 'ximena.paredes.s4@empresa.com'),  -- Gerente
(4, 2, 'Yamila', 'Quinteros', '50000038', 'yamila.quinteros.s4@empresa.com'), -- Analista
(4, 2, 'Zacarias', 'Rodríguez', '50000039', 'zacarias.rodriguez.s4@empresa.com'), -- Analista
(4, 3, 'Adriana', 'Sánchez', '50000040', 'adriana.sanchez.s4@empresa.com'), -- Cobranza
(4, 3, 'Bruno', 'Torres', '50000041', 'bruno.torres.s4@empresa.com'),      -- Cobranza
(4, 1, 'Camila', 'Vera', '50000042', 'camila.vera.s4@empresa.com'),        -- Atención
(4, 1, 'Diego', 'Winkler', '50000043', 'diego.winkler.s4@empresa.com'),     -- Atención
(4, 1, 'Erica', 'Yunes', '50000044', 'erica.yunes.s4@empresa.com'),         -- Atención
(4, 1, 'Fabián', 'Zelaya', '50000045', 'fabian.zelaya.s4@empresa.com'),     -- Atención
(4, 1, 'Giselle', 'Acosta', '50000046', 'giselle.acosta.s4@empresa.com'),   -- Atención
(4, 3, 'Hernan', 'Benítez', '50000047', 'hernan.benitez.s4@empresa.com'),  -- Cobranza
(4, 2, 'Inés', 'Castro', '50000048', 'ines.castro.s4@empresa.com'),         -- Analista
-- SUCURSAL 5 (CABA Microcentro - 12 Empleados)
(5, 4, 'Javier', 'Díaz', '50000049', 'javier.diaz.s5@empresa.com'),       -- Gerente
(5, 2, 'Laura', 'Espósito', '50000050', 'laura.esposito.s5@empresa.com'),  -- Analista
(5, 2, 'Martín', 'Flores', '50000051', 'martin.flores.s5@empresa.com'),   -- Analista
(5, 3, 'Nora', 'Gómez', '50000052', 'nora.gomez.s5@empresa.com'),         -- Cobranza
(5, 3, 'Pablo', 'Heredia', '50000053', 'pablo.heredia.s5@empresa.com'),   -- Cobranza
(5, 1, 'Quimey', 'Ibarra', '50000054', 'quimey.ibarra.s5@empresa.com'),   -- Atención
(5, 1, 'Román', 'Jerez', '50000055', 'roman.jerez.s5@empresa.com'),        -- Atención
(5, 1, 'Sonia', 'Koval', '50000056', 'sonia.koval.s5@empresa.com'),        -- Atención
(5, 1, 'Mario', 'Lescano', '50000057', 'mario.lescano.s5@empresa.com'),    -- Atención
(5, 1, 'Ezequiel', 'Méndez', '50000058', 'ezequiel.mendez.s5@empresa.com'), -- Atención
(5, 5, 'Belén', 'Navarro', '50000059', 'belen.navarro.s5@empresa.com'),    -- Administrativo
(5, 3, 'Cecilia', 'Ortiz', '50000060', 'cecilia.ortiz.s5@empresa.com');    -- Cobranza

-- HistoricoTasa
INSERT INTO HistoricoTasa (idProducto, tasa, fechaInicio, fechaFin) VALUES 
...
-- SolicitudCredito
INSERT INTO SolicitudCredito (idCliente, idEmpleado, idProducto, idSucursalAlta, idEstadoSolicitud, idEvaluacionRelevante, montoSolicitado, destino, fechaSolicitud) VALUES 
-- Productos Personales (1-12) y Hipotecarios (13-24)
(1, 6, 1, 1, 2, 1, 120000.00, 'Compra de moto', '2025-01-10 09:30:00'),      -- Aprobada
(2, 18, 14, 2, 3, 2, 15000000.00, 'Compra de casa nueva', '2025-01-11 10:00:00'), -- Rechazada (por evaluación de riesgo 2)
(3, 30, 3, 3, 2, 3, 500000.00, 'Viaje familiar', '2025-01-12 11:15:00'),      -- Aprobada
(4, 42, 16, 4, 2, 4, 8000000.00, 'Refacción de departamento', '2025-01-13 12:30:00'), -- Aprobada
(5, 54, 5, 5, 3, 5, 300000.00, 'Adquisición de equipamiento deportivo', '2025-01-14 14:00:00'), -- Rechazada
(6, 7, 18, 1, 2, 6, 10000000.00, 'Vivienda única', '2025-01-15 15:30:00'),     -- Aprobada
(7, 19, 7, 2, 1, 7, 180000.00, 'Estudios de posgrado', '2025-01-16 09:00:00'), -- Pendiente
(8, 31, 20, 3, 2, 8, 12000000.00, 'Vivienda de veraneo', '2025-01-17 10:45:00'), -- Aprobada
(9, 43, 9, 4, 3, 9, 400000.00, 'Consolidación de deudas', '2025-01-18 13:00:00'), -- Rechazada
(10, 55, 22, 5, 2, 10, 20000000.00, 'Adquisición de terreno', '2025-01-19 14:30:00'), -- Aprobada
(11, 8, 11, 1, 2, 11, 700000.00, 'Compra de automóvil usado', '2025-01-20 09:45:00'), -- Aprobada
(12, 20, 24, 2, 2, 12, 11500000.00, 'Hipotecario con destino comercial', '2025-01-21 11:30:00'), -- Aprobada
(13, 32, 2, 3, 3, 13, 250000.00, 'Reemplazo de electrodomésticos', '2025-01-22 13:45:00'), -- Rechazada
(14, 44, 13, 4, 2, 14, 18000000.00, 'Compra de propiedad en el exterior', '2025-01-23 15:00:00'), -- Aprobada
(15, 56, 4, 5, 2, 15, 65000.00, 'Gastos médicos', '2025-01-24 16:30:00'),     -- Aprobada
(16, 9, 15, 1, 2, 16, 9000000.00, 'Construcción en lote propio', '2025-01-25 10:15:00'), -- Aprobada
(17, 21, 6, 2, 4, 17, 350000.00, 'Inversión en criptomonedas', '2025-01-26 11:45:00'), -- En Revisión
(18, 33, 17, 3, 3, 18, 10000000.00, 'Hipotecario con garantía de tercero', '2025-01-27 13:00:00'), -- Rechazada
(19, 45, 8, 4, 2, 19, 220000.00, 'Viaje al Caribe', '2025-01-28 14:15:00'),      -- Aprobada
(20, 57, 10, 5, 2, 20, 4000000.00, 'Comprar un NFT de alto valor', '2025-01-29 15:45:00'),  -- Aprobada
-- Productos Empresariales (25-36) y Leasing (37-48)
(21, 10, 25, 1, 2, 21, 3500000.00, 'Ampliación de Capital de Trabajo', '2025-02-01 09:00:00'), -- Aprobada
(22, 22, 38, 2, 2, 22, 7000000.00, 'Leasing de maquinaria pesada', '2025-02-02 10:30:00'),    -- Aprobada
(23, 34, 27, 3, 3, 23, 5000000.00, 'Inversión en bolsa', '2025-02-03 11:45:00'),        -- Rechazada
(24, 46, 40, 4, 2, 24, 5500000.00, 'Leasing de flota de vehículos (5 unidades)', '2025-02-04 13:00:00'), -- Aprobada
(25, 58, 29, 5, 2, 25, 1000000.00, 'Línea de crédito rotatoria', '2025-02-05 14:15:00'), -- Aprobada
(26, 11, 42, 1, 3, 26, 10000000.00, 'Leasing de inmueble para oficina', '2025-02-06 15:45:00'), -- Rechazada
(27, 23, 31, 2, 2, 27, 6500000.00, 'Préstamo Agropecuario (Siembra)', '2025-02-07 09:30:00'), -- Aprobada
(28, 35, 44, 3, 2, 28, 4000000.00, 'Leasing de equipamiento informático', '2025-02-08 11:00:00'), -- Aprobada
(29, 47, 33, 4, 3, 29, 2000000.00, 'Crédito MiPyME para exportación', '2025-02-09 12:45:00'), -- Rechazada
(30, 59, 46, 5, 2, 30, 3000000.00, 'Leasing de transporte de pasajeros', '2025-02-10 14:00:00'), -- Aprobada
(31, 12, 35, 1, 2, 31, 4000000.00, 'Préstamo Tecnológico', '2025-02-11 15:15:00'),     -- Aprobada
(32, 24, 48, 2, 2, 32, 7000000.00, 'Leasing de maquinaria de construcción', '2025-02-12 16:45:00'), -- Aprobada
(33, 36, 30, 3, 3, 33, 10000000.00, 'Crédito comercial en USD', '2025-02-13 09:00:00'),  -- Rechazada
(34, 48, 37, 4, 2, 34, 2000000.00, 'Leasing de vehículos utilitarios', '2025-02-14 10:30:00'), -- Aprobada
(35, 60, 39, 5, 4, 35, 8000000.00, 'Crédito para Franquicia', '2025-02-15 12:00:00'),     -- En Revisión
(36, 1, 41, 1, 2, 36, 5000000.00, 'Leasing de maquinaria agrícola', '2025-02-16 13:30:00'), -- Aprobada
(37, 13, 26, 2, 2, 37, 8000000.00, 'Crédito PyME para Inversión', '2025-02-17 14:45:00'),  -- Aprobada
(38, 25, 43, 3, 2, 38, 3000000.00, 'Leasing de equipamiento médico', '2025-02-18 16:00:00'), -- Aprobada
(39, 37, 28, 4, 3, 39, 1500000.00, 'Préstamo Empresarial Nuevo', '2025-02-19 09:15:00'), -- Rechazada
(40, 49, 45, 5, 2, 40, 4500000.00, 'Leasing de tecnología de punta', '2025-02-20 10:45:00'), -- Aprobada
-- Tarjetas Corporativas (49-60) 
(41, 50, 49, 5, 2, 41, 1500000.00, 'Gastos de Representación (Tarjeta)', '2025-03-01 12:30:00'), -- Aprobada
(42, 2, 51, 1, 3, 42, 2000000.00, 'Ampliación límite tarjeta corporativa', '2025-03-02 14:00:00'), -- Rechazada
(43, 14, 53, 2, 2, 43, 3500000.00, 'Adquisición de flota (Tarjeta)', '2025-03-03 15:30:00'),  -- Aprobada
(44, 26, 55, 3, 2, 44, 400000.00, 'Gastos de viaje y hotelería', '2025-03-04 09:45:00'), -- Aprobada
(45, 38, 57, 4, 2, 45, 600000.00, 'Tarjeta para profesionales independientes', '2025-03-05 11:15:00'), -- Aprobada
(46, 51, 59, 5, 3, 46, 1000000.00, 'Tarjeta Premium Viajes', '2025-03-06 12:45:00'),  -- Rechazada
(47, 3, 60, 1, 2, 47, 850000.00, 'Tarjeta Corporativa Servicios', '2025-03-07 14:00:00'),  -- Aprobada
(48, 15, 50, 2, 2, 48, 1000000.00, 'Compra de insumos (Tarjeta PyME)', '2025-03-08 15:30:00'), -- Aprobada
(49, 27, 52, 3, 2, 49, 4500000.00, 'Límite Tarjeta Black', '2025-03-09 10:00:00'), -- Aprobada
(50, 39, 54, 4, 3, 50, 500000.00, 'Financiación de gastos menores', '2025-03-10 11:30:00'), -- Rechazada
(51, 52, 56, 5, 2, 51, 300000.00, 'Tarjeta para gastos iniciales de Startup', '2025-03-11 13:00:00'), -- Aprobada
(52, 4, 58, 1, 4, 52, 700000.00, 'Tarjeta Monotributista (Ampliación)', '2025-03-12 14:30:00'), -- En Revisión
(53, 16, 12, 2, 2, 53, 400000.00, 'Préstamo de Libre Disponibilidad', '2025-03-13 16:00:00'), -- Aprobada
(54, 28, 23, 3, 2, 54, 15000000.00, 'Hipotecario Tasa Variable', '2025-03-14 10:15:00'), -- Aprobada
(55, 40, 34, 4, 3, 55, 3000000.00, 'Préstamo Comercial en USD', '2025-03-15 11:45:00'), -- Rechazada
(56, 53, 47, 5, 2, 56, 2500000.00, 'Leasing de Software', '2025-03-16 13:00:00'), -- Aprobada
(57, 5, 59, 1, 2, 57, 1800000.00, 'Tarjeta Corporate Oro', '2025-03-17 14:15:00'),   -- Aprobada
(58, 17, 36, 2, 2, 58, 5500000.00, 'Préstamo Sustentable', '2025-03-18 15:30:00'),  -- Aprobada
(59, 29, 49, 3, 3, 59, 4000000.00, 'Leasing de Construcción', '2025-03-19 09:30:00'), -- Rechazada
(60, 41, 10, 4, 2, 60, 550000.00, 'Préstamo Rápido Online', '2025-03-20 11:00:00');  -- Aprobada

-- Credito 
INSERT INTO Credito (idSolicitud, idProducto, montoOtorgado, tasaInteres, plazoMeses, fechaInicio, fechaFin, idCreditoRefinanciado) VALUES 
...
(6, 18, 9500000.00, 14.89, 240, '2025-01-25', '2045-01-25', NULL), -- Se otorga menos que lo solicitado
...
(14, 13, 17500000.00, 10.25, 240, '2025-02-02', '2045-02-02', NULL), -- Se otorga menos
...
-- Cuota
INSERT INTO Cuota (idCredito, numeroCuota, fechaVencimiento, montoTotal, idEstadoCuota) VALUES 
-- CRÉDITO 1: (idCredito: 1, Monto: 120000.00, Tasa: 65.19, Plazo: 12M, Inicio: 2025-01-20)
(1, 1, '2025-02-20', 13735.20, 2), -- Pagada
(1, 2, '2025-03-20', 13735.20, 2), -- Pagada
(1, 3, '2025-04-20', 13735.20, 3), -- Vencida (pago en mora)
...
(2, 1, '2025-02-22', 20389.04, 2), -- Pagada
(2, 2, '2025-03-22', 20389.04, 3), -- Vencida
(2, 3, '2025-04-22', 20389.04, 3), -- Vencida
...
(3, 1, '2025-02-23', 88920.00, 2), -- Pagada
(3, 2, '2025-03-23', 88920.00, 2), -- Pagada
...
(4, 1, '2025-02-25', 56708.96, 2), -- Pagada
(4, 2, '2025-03-25', 56708.96, 2), -- Pagada
...
(5, 1, '2025-02-27', 81680.00, 2), -- Pagada
(5, 2, '2025-03-27', 81680.00, 2), -- Pagada
...
-- Pago 
INSERT INTO Pago (idCuota, idMetodoPago, fechaPago, montoPagado, diasDemora) VALUES 
...
-- CampaniaProducto 
INSERT INTO CampaniaProducto (idCampania, idProducto) VALUES 
...
-- CampaniaCliente
INSERT INTO CampaniaCliente (idCampania, idCliente) VALUES 
...
-- EvaluacionGarante 
INSERT INTO EvaluacionGarante (idEvaluacion, idGarante) VALUES 
(1, 1), 
(2, 2), 
(3, 3), 
(4, 4), 
...
-- EvaluacionCliente 
INSERT INTO EvaluacionCliente (idEvaluacion, idCliente) VALUES 
(1, 1), 
(2, 2), 
(3, 3), 
(4, 4), 
...
-- GaranteSolicitud
INSERT INTO GaranteSolicitud (idGarante, idSolicitud) VALUES 
-- GRUPO 1: Garante Primario para las 40 Solicitudes Aprobadas (Garante 1-40)
(1, 1),    (2, 3),    (3, 4),    (4, 6),    (5, 8),    (6, 10),    (7, 11),    (8, 12),
(9, 14),   (10, 15),  (11, 16),  (12, 19),  (13, 20),  (14, 21),   (15, 22),   (16, 24),
(17, 25),  (18, 27),  (19, 28),  (20, 30),  (21, 31),  (22, 32),   (23, 34),   (24, 36),
(25, 37),  (26, 38),  (27, 40),  (28, 41),  (29, 43),  (30, 44),   (31, 45),   (32, 47),
(33, 48),  (34, 49),  (35, 51),  (36, 53),  (37, 54),  (38, 56),   (39, 57),   (40, 58),
...
(60, 54);  -- Solicitud 54 (Hipotecario)